            ...
            <div className="flex gap-3">
              <button
                ...
                onClick={() => {
                  ...
                  dispatch(
                    changeLeftSidebarColorType(LEFT_SIDEBAR_COLOR_TYPES.LIGHT)
                  );
                }}
              ...
              <button
                ...
                onClick={() => {
                  ...
                  dispatch(
                    changeLeftSidebarColorType(LEFT_SIDEBAR_COLOR_TYPES.DARK)
                  );
                }}
                type="button"
                id="dataModeTwo"
          ...
          <div className="mt-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                onClick={() => {
                  dispatch(
                    changeLayoutContentWidth(LAYOUT_CONTENT_WIDTH.FLUID)
                  );
                }}
                type="button"
                id="datawidthOne"
              ...
              <button
                ...
                onClick={() => {
                  dispatch(
                    changeLayoutContentWidth(LAYOUT_CONTENT_WIDTH.BOXED)
                  );
                }}
                type="button"
                id="datawidthTwo"
            ...
            <div className="mt-6" id="sidebar-size">
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  onClick={() => {
                    dispatch(
                      changeLeftsidebarSizeType(LEFT_SIDEBAR_SIZE_TYPES.DEFAULT)
                    );
                  }}
                  type="button"
                  id="sidebarSizeOne"
                ...
                <button
                  ...
                  onClick={() => {
                    dispatch(
                      changeLeftsidebarSizeType(LEFT_SIDEBAR_SIZE_TYPES.COMPACT)
                    );
                  }}
                  type="button"
                  id="sidebarSizeTwo"
            ...
            <div className="mt-6" id="sidebar-color">
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  id="sidebarColorOne"
                  name="sidebarColor"
                  className={`flex items-center justify-center size-10 bg-white border rounded-md border-slate-200 group ${layoutSidebarColorType === LEFT_SIDEBAR_COLOR_TYPES.LIGHT ? 'active' : ''}`}
                >
                  <Check className="size-5 hidden group-[.active]:inline-block text-slate-600" />
                </button>
                <button
                  ...
                  id="sidebarColorTwo"
                  name="sidebarColor"
                  className={`flex items-center justify-center size-10 border rounded-md border-zink-900 bg-zink-900 group ${layoutSidebarColorType === LEFT_SIDEBAR_COLOR_TYPES.DARK ? 'active' : ''}`}
                >
                  <Check className="size-5 hidden group-[.active]:inline-block text-white" />
                </button>
                <button
                  value={LEFT_SIDEBAR_COLOR_TYPES.BRAND}
                  onClick={() => {
                    dispatch(
                      changeLeftSidebarColorType(LEFT_SIDEBAR_COLOR_TYPES.BRAND)
                    );
                  }}
                  type="button"
                  id="sidebarColorThree"
                  name="sidebarColor"
                  className={`flex items-center justify-center size-10 border rounded-md border-custom-800 bg-custom-800 group ${layoutSidebarColorType === LEFT_SIDEBAR_COLOR_TYPES.BRAND ? 'active' : ''}`}
                >
                  <Check className="size-5 hidden group-[.active]:inline-block text-white" />
                </button>
                <button
                  ...
                  id="sidebarColorFour"
                  name="sidebarColor"
                  className={`flex items-center justify-center size-10 border rounded-md border-purple-950 bg-gradient-to-t from-red-400 to-purple-500 group ${layoutSidebarColorType === LEFT_SIDEBAR_COLOR_TYPES.MODERN ? 'active' : ''}`}
                >
                  <Check className="size-5 hidden group-[.active]:inline-block text-white" />
                </button>
              </div>
