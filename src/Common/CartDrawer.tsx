    ...
    <React.Fragment>
      ...
      >
        ...
        {/* <div className="px-4 py-3 text-sm text-green-500 border border-transparent bg-green-50 dark:bg-green-400/20">
                    <span className="font-bold underline">TAILWICK50</span> Coupon applied successfully.
                </div> */}
        <div>
          <div className="h-[calc(100vh_-_325px)] p-4 overflow-y-auto product-list">
                ...
                >
                  ...
                  <div className="overflow-hidden grow">
                    ...
                    <div className="flex items-center mb-3">
                      ...
                      <div
                        className={`font-normal rtl:mr-1 ltr:ml-1 dark:text-zink-200 ${index === addToCard.length - 3 ? 'text-slate-500' : 'text-slate-400'}`}
                      >
                        ({item.name})
                      </div>
                    </div>
          ...
          <div className="p-4 border-t border-slate-200 dark:border-zink-500">
            <table className="w-full mb-3 ">
              <tbody className="table-total">
                ...
                <tr>
                  <td className="py-2">
                    Discount <span className="text-muted">(New Year)</span>:
                  </td>
                  <td className="text-right cart-discount">
                    -${dis.toFixed(2)}
                  </td>
                </tr>
                <tr>
