...
const widgetsData: WidgetData[] = [
  ...
  },
  {
    id: 2,
    icon: (
      <MousePointerClick className="inline-block size-4 ltr:mr-1 rtl:ml-1" />
    ),
    price: 92.74,
    name: 'Open Rate',
  ...
  },
  {
    id: 3,
    icon: (
      <MousePointerSquare className="inline-block size-4 ltr:mr-1 rtl:ml-1" />
    ),
    price: 3.79,
    name: 'CLICKS RATE',
...
const storyData = [
  ...
  },
  {
    ...
    image: avatar7,
    username: '@genesis',
    bgColor: 'bg-custom-100 dark:bg-custom-500/20',
    isActive: false,
  },
  {
    id: 8,
    image: avatar8,
    username: '@brayan_herman',
