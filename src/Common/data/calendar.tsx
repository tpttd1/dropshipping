...
const Events = [
  {
    ...
    className:
      'border-none rounded-md py-1.5 px-3 w-[100%] text-purple-500 !bg-purple-100 dark:!bg-purple-500/20',
  },
  {
    id: '2',
    title: 'Long Event',
    ...
    className:
      'border-none rounded-md py-1.5 px-3 w-[100%] text-sky-500 !bg-sky-100 dark:!bg-sky-500/20',
  },
  {
    id: '3',
    ...
    allDay: false,
    className:
      'border-none rounded-md py-1.5 px-3 w-[100%] text-yellow-500 !bg-yellow-100 dark:!bg-yellow-500/20',
  },
  {
    id: '4',
    title: 'Repeating Event',
    ...
    allDay: false,
    className:
      'border-none rounded-md py-1.5 px-3 w-[100%] transition-all text-custom-500 !bg-custom-100 dark:!bg-custom-500/20',
  },
  {
    id: '5',
    title: 'Meeting',
    ...
    allDay: false,
    className:
      'border-none rounded-md py-1.5 px-3 w-[100%] text-green-500 !bg-green-100 dark:!bg-green-500/20',
  },
  {
    id: '6',
    title: 'Lunch',
  ...
  },
  {
    ...
    url: 'http://google.com/',
    className:
      'border-none rounded-md py-1.5 px-3 w-[100%] text-custom-500 !bg-custom-100 dark:!bg-custom-500/20',
  },
];
