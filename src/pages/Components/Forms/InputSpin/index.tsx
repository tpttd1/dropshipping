    ...
    <React.Fragment>
      <div className="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div className="grid grid-cols-1 gap-x-5 xl:grid-cols-1">
          <div className="card">
            <div className="card-body">
              ...
              <div className="flex flex-wrap gap-4">
                <Counter
                  initialValue={15}
                  className="inline-flex p-2 text-center border rounded input-step border-slate-200 dark:border-zink-500"
                  inputClass="text-center ltr:pl-2 rtl:pr-2 w-15 h-7 product-quantity dark:bg-zink-700 focus:shadow-none"
                  decrementClass="border w-7 leading-[15px] minusBtn bg-slate-200 dark:bg-zink-600 dark:border-zink-600 rounded transition-all duration-200 ease-linear border-slate-200 text-slate-500 dark:text-zink-200 hover:bg-custom-500 dark:hover:bg-custom-500 hover:text-custom-50 dark:hover:text-custom-50 hover:border-custom-500 dark:hover:border-custom-500 focus:bg-custom-500 dark:focus:bg-custom-500 focus:border-custom-500 dark:focus:border-custom-500 focus:text-custom-50 dark:focus:text-custom-50"
                  incrementClass="transition-all duration-200 ease-linear border rounded border-slate-200 bg-slate-200 dark:bg-zink-600 dark:border-zink-600 w-7 plusBtn text-slate-500 dark:text-zink-200 hover:bg-custom-500 dark:hover:bg-custom-500 hover:text-custom-50 dark:hover:text-custom-50 hover:border-custom-500 dark:hover:border-custom-500 focus:bg-custom-500 dark:focus:bg-custom-500 focus:border-custom-500 dark:focus:border-custom-500 focus:text-custom-50 dark:focus:text-custom-50"
                />
                <Counter
                  initialValue={19}
                  className="inline-flex p-2 text-center border rounded input-step border-slate-200 dark:border-zink-500"
                  inputClass="text-center ltr:pl-2 rtl:pr-2 w-15 h-7 product-quantity dark:bg-zink-700 focus:shadow-none"
                  decrementClass="border w-7 leading-[15px] minusBtn bg-custom-200 dark:bg-custom-900 dark:border-custom-900 rounded transition-all duration-200 ease-linear border-custom-200 text-custom-500  hover:bg-custom-500 dark:hover:bg-custom-500 hover:text-custom-50 hover:border-custom-500 dark:hover:border-custom-500 focus:bg-custom-500 dark:focus:bg-custom-500 focus:border-custom-500 dark:focus:border-custom-500 focus:text-custom-50"
                  incrementClass="transition-all duration-200 ease-linear border rounded border-custom-200 bg-custom-200 dark:bg-custom-900 dark:border-custom-900 w-7 plusBtn text-custom-500 hover:bg-custom-500 dark:hover:bg-custom-500 hover:text-custom-50 hover:border-custom-500 dark:hover:border-custom-500 focus:bg-custom-500 dark:focus:bg-custom-500 focus:border-custom-500 dark:focus:border-custom-500 focus:text-custom-50"
                />
                <Counter
                  initialValue={33}
                  className="inline-flex p-2 text-center border rounded input-step border-slate-200 dark:border-zink-500"
                  inputClass="text-center ltr:pl-2 rtl:pr-2 w-15 h-7 product-quantity dark:bg-zink-700 focus:shadow-none"
                  decrementClass="border w-7 leading-[15px] minusBtn bg-green-200 dark:bg-green-900 dark:border-green-900 rounded transition-all duration-200 ease-linear border-green-200 text-green-500 hover:bg-green-500 dark:hover:bg-green-500 hover:text-green-50 hover:border-green-500 dark:hover:border-green-500 focus:bg-green-500 dark:focus:bg-green-500 focus:border-green-500 dark:focus:border-green-500 focus:text-green-50"
                  incrementClass="text-green-500 transition-all duration-200 ease-linear bg-green-200 border border-green-200 rounded dark:bg-green-900 dark:border-green-900 w-7 plusBtn hover:bg-green-500 dark:hover:bg-green-500 hover:text-green-50 hover:border-green-500 dark:hover:border-green-500 focus:bg-green-500 dark:focus:bg-green-500 focus:border-green-500 dark:focus:border-green-500 focus:text-green-50"
                />
                <Counter
                  initialValue={10}
                  className="inline-flex p-2 text-center border rounded input-step border-slate-200 dark:border-zink-500"
                  inputClass="text-center ltr:pl-2 rtl:pr-2 w-15 h-7 product-quantity dark:bg-zink-700 focus:shadow-none"
                  decrementClass="border w-7 leading-[15px] minusBtn bg-orange-200 dark:bg-orange-900 dark:border-orange-900 rounded transition-all duration-200 ease-linear border-orange-200 text-orange-500 hover:bg-orange-500 dark:hover:bg-orange-500 hover:text-orange-50 hover:border-orange-500 dark:hover:border-orange-500 focus:bg-orange-500 dark:focus:bg-orange-500 focus:border-orange-500 dark:focus:border-orange-500 focus:text-orange-50"
                  incrementClass="text-orange-500 transition-all duration-200 ease-linear bg-orange-200 border-orange-200 rounded dark:bg-orange-900 dark:border-orange-900border w-7 plusBtn hover:bg-orange-500 dark:hover:bg-orange-500 hover:text-orange-50 hover:border-orange-500 dark:hover:border-orange-500 focus:bg-orange-500 dark:focus:bg-orange-500 focus:border-orange-500 dark:focus:border-orange-500 focus:text-orange-50"
                />
                <Counter
                  initialValue={25}
                  className="inline-flex p-2 text-center border rounded input-step border-slate-200 dark:border-zink-500"
                  inputClass="text-center ltr:pl-2 rtl:pr-2 w-15 h-7 product-quantity dark:bg-zink-700 focus:shadow-none"
                  decrementClass="border w-7 leading-[15px] minusBtn bg-sky-200 dark:bg-sky-900 dark:border-sky-900 rounded transition-all duration-200 ease-linear border-sky-200 text-sky-500 hover:bg-sky-500 dark:hover:bg-sky-500 hover:text-sky-50 hover:border-sky-500 dark:hover:border-sky-500 focus:bg-sky-500 dark:focus:bg-sky-500 focus:border-sky-500 dark:focus:border-sky-500 focus:text-sky-50"
                  incrementClass="transition-all duration-200 ease-linear border rounded text-sky-500 bg-sky-200 dark:bg-sky-900 dark:border-sky-900 border-sky-200 w-7 plusBtn hover:bg-sky-500 dark:hover:bg-sky-500 hover:text-sky-50 hover:border-sky-500 dark:hover:border-sky-500 focus:bg-sky-500 dark:focus:bg-sky-500 focus:border-sky-500 dark:focus:border-sky-500 focus:text-sky-50"
                />
                <Counter
                  initialValue={10}
                  className="inline-flex p-2 text-center border rounded input-step border-slate-200 dark:border-zink-500"
                  inputClass="text-center ltr:pl-2 rtl:pr-2 w-15 h-7 product-quantity dark:bg-zink-700 focus:shadow-none"
                  decrementClass="border w-7 leading-[15px] minusBtn bg-yellow-200 dark:bg-yellow-900 dark:border-yellow-900 rounded transition-all duration-200 ease-linear border-yellow-200 text-yellow-500 hover:bg-yellow-500 dark:hover:bg-yellow-500 hover:text-yellow-50 hover:border-yellow-500 dark:hover:border-yellow-500 focus:bg-yellow-500 dark:focus:bg-yellow-500 focus:border-yellow-500 dark:focus:border-yellow-500 focus:text-yellow-50"
                  incrementClass="text-yellow-500 transition-all duration-200 ease-linear bg-yellow-200 border border-yellow-200 rounded dark:bg-yellow-900 dark:border-yellow-900 w-7 plusBtn hover:bg-yellow-500 dark:hover:bg-yellow-500 hover:text-yellow-50 hover:border-yellow-500 dark:hover:border-yellow-500 focus:bg-yellow-500 dark:focus:bg-yellow-500 focus:border-yellow-500 dark:focus:border-yellow-500 focus:text-yellow-50"
                />
                <Counter
                  initialValue={18}
                  className="inline-flex p-2 text-center border rounded input-step border-slate-200 dark:border-zink-500"
          ...
          <div className="card">
            <div className="card-body">
              <h6 className="mb-4 text-15">Rounded Example</h6>
              <div className="flex flex-wrap items-center gap-4">
                <Counter
                  initialValue={50}
                  className="inline-flex text-center input-step"
                  inputClass="text-center ltr:pl-2 rtl:pr-2 w-15 h-7 product-quantity dark:bg-zink-700 focus:shadow-none"
                  decrementClass="border w-7 leading-[15px] minusBtn bg-slate-200 dark:bg-zink-600 dark:border-zink-600 rounded-full transition-all duration-200 ease-linear border-slate-200 text-slate-500 dark:text-zink-200 hover:bg-custom-500 dark:hover:bg-custom-500 hover:text-custom-50 dark:hover:text-custom-50 hover:border-custom-500 focus:bg-custom-500 focus:border-custom-500 focus:text-custom-50"
                  incrementClass="transition-all duration-200 ease-linear border rounded-full border-slate-200 dark:bg-zink-600 dark:border-zink-600 bg-slate-200 w-7 plusBtn text-slate-500 dark:text-zink-200 hover:bg-custom-500 dark:hover:bg-custom-500 hover:text-custom-50 dark:hover:text-custom-50 hover:border-custom-500 focus:bg-custom-500 focus:border-custom-500 focus:text-custom-50"
                />
                <Counter
                  initialValue={19}
                  className="inline-flex text-center input-step"
                  ...
                  incrementClass="border w-7 leading-[15px] minusBtn bg-custom-200 dark:bg-custom-900 dark:border-custom-900 rounded-full transition-all duration-200 ease-linear border-custom-200 text-custom-500  hover:bg-custom-500 dark:hover:bg-custom-500 hover:text-custom-50 hover:border-custom-500 dark:hover:border-custom-500 focus:bg-custom-500 dark:focus:bg-custom-500 focus:border-custom-500 dark:focus:border-custom-500 focus:text-custom-50"
                />
                <Counter
                  initialValue={33}
                  className="inline-flex text-center input-step"
                  ...
                  incrementClass="text-green-500 transition-all duration-200 ease-linear bg-green-200 border border-green-200 rounded-full dark:bg-green-900 dark:border-green-900 w-7 plusBtn hover:bg-green-500 dark:hover:bg-green-500 hover:text-green-50 hover:border-green-500 dark:hover:border-green-500 focus:bg-green-500 dark:focus:bg-green-500 focus:border-green-500 dark:focus:border-green-500 focus:text-green-50"
                />
                <Counter
                  initialValue={10}
                  className="inline-flex text-center input-step"
                  ...
                  incrementClass="text-orange-500 transition-all duration-200 ease-linear bg-orange-200 border-orange-200 rounded-full dark:bg-orange-900 dark:border-orange-900border w-7 plusBtn hover:bg-orange-500 dark:hover:bg-orange-500 hover:text-orange-50 hover:border-orange-500 dark:hover:border-orange-500 focus:bg-orange-500 dark:focus:bg-orange-500 focus:border-orange-500 dark:focus:border-orange-500 focus:text-orange-50"
                />
                <Counter
                  initialValue={40}
                  className="inline-flex text-center input-step"
