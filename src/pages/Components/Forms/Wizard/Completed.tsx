    ...
    <React.Fragment>
      <div className="px-4 py-6 mx-auto text-center lg:w-2/3">
        ...
        <p className="mb-5 text-slate-500 text-15">
          We are thrilled to inform you that your registration has been
          successfully processed! Welcome to our community. Thank you for
          choosing us, and we look forward to serving you. Stay connected and
        ...
        >
          <span className="align-middle">Try Login</span>{' '}
