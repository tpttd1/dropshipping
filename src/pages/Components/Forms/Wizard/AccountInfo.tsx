...
import { Gem, Globe, MoveLeft, MoveRight, Smartphone } from 'lucide-react';
...
const AccountInfo = () => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <label htmlFor="" className="inline-block mb-3 text-base font-medium">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            {validation.touched.userName && validation.errors.userName ? (
              <div id="userName" className="text-red-500">
          ...
          <div>
            ...
            validation.errors.confirmPassword ? (
              <div id="confirmPassword" className="text-red-500">
                {validation.errors.confirmPassword}
              </div>
            ) : null}
          </div>
        ...
        <div className="flex justify-between gap-2 mt-5">
          ...
          >
            <MoveLeft className="inline-block h-4 mr-1 rtl:rotate-180" />{' '}
