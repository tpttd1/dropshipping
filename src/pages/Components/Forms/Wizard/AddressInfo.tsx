    ...
    <React.Fragment>
      ...
      >
        <div className="grid grid-cols-1 gap-4 mb-4 md:grid-cols-3">
          ...
          <div>
            <label
              htmlFor="middleNameAddressInput"
              className="inline-block mb-2 text-base font-medium"
            >
            ...
            {validation.touched.middleName && validation.errors.middleName ? (
              <div id="middleName" className="text-red-500">
        ...
        <div className="grid grid-cols-1 gap-4 mb-4 md:grid-cols-2">
          <div>
            <label
              htmlFor="phoneNumberAddressInput"
              className="inline-block mb-2 text-base font-medium"
            >
              Phone Number
            </label>
          ...
          <div>
            ...
            {validation.touched.addressLine && validation.errors.addressLine ? (
              <div id="addressLine" className="text-red-500">
                {validation.errors.addressLine}
              </div>
            ) : null}
          </div>
          <div>
            ...
            validation.errors.addressLine2 ? (
              <div id="addressLine2" className="text-red-500">
                {validation.errors.addressLine2}
              </div>
            ) : null}
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 mb-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            ...
            {validation.touched.state && validation.errors.state ? (
              <div id="state" className="text-red-500">
          ...
          <div>
            ...
            {validation.touched.country && validation.errors.country ? (
              <div id="country" className="text-red-500">
          ...
          <div>
            ...
            {validation.touched.zipCode && validation.errors.zipCode ? (
              <div id="zipCode" className="text-red-500">
          ...
          <div>
            ...
            {validation.touched.vtaAddress && validation.errors.vtaAddress ? (
              <div id="vtaAddress" className="text-red-500">
                {validation.errors.vtaAddress}
              </div>
            ) : null}
          </div>
          <div>
            <label
              htmlFor="prefixAddressInput"
              className="inline-block mb-2 text-base font-medium"
            >
              Prefix
            </label>
            <input
              ...
              onBlur={validation.handleBlur}
            />
            {validation.touched.prefixAddress &&
            validation.errors.prefixAddress ? (
              <div id="prefixAddress" className="text-red-500">
                {validation.errors.prefixAddress}
              </div>
            ) : null}
          </div>
        ...
        <div className="flex justify-between gap-2 mt-5">
          ...
          >
            ...
            <MoveRight className="inline-block h-4 ml-1" />
          </button>
        </div>
      </form>
    </React.Fragment>
