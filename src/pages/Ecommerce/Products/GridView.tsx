...
const GridView = () => {
  ...
  return (
    <React.Fragment>
      <BreadCrumb title="Search Products" pageTitle="Products" />
      <DeleteModal
        show={deleteModal}
        onHide={deleteToggle}
              ...
              <div className="mt-4 collapsible">
                ...
                <div className="mt-4 collapsible-content">
                  <div className="flex flex-wrap items-center gap-2">
                    <input
                      id="color1"
                      className="size-5 border rounded-sm appearance-none cursor-pointer border-custom-500 bg-custom-500 checked:bg-custom-500 checked:border-custom-500"
                      type="checkbox"
                      value=""
                    />
                    <input
                      id="color2"
                      className="size-5 bg-red-300 border border-red-300 rounded-sm appearance-none cursor-pointer checked:bg-red-300 checked:border-red-300"
                      type="checkbox"
                      value=""
                    />
                    <input
                      id="color3"
                      className="size-5 bg-green-300 border border-green-300 rounded-sm appearance-none cursor-pointer checked:bg-green-300 checked:border-green-300"
                      type="checkbox"
                      value=""
                    />
                    <input
                      id="color4"
                      className="size-5 border rounded-sm appearance-none cursor-pointer border-slate-500 bg-slate-500 checked:bg-slate-500 checked:border-slate-500"
                      type="checkbox"
                      value=""
                    />
                    <input
                      id="color5"
                      className="size-5 bg-purple-500 border border-purple-500 rounded-sm appearance-none cursor-pointer checked:bg-purple-500 checked:border-purple-500"
                      type="checkbox"
                      value=""
                    />
                    <input
                      id="color6"
                      className="size-5 border rounded-sm appearance-none cursor-pointer bg-sky-500 border-sky-500 checked:bg-sky-500 checked:border-sky-500"
                      type="checkbox"
                      value=""
                    />
                    <input
                      id="color7"
                      className="size-5 bg-yellow-500 border border-yellow-500 rounded-sm appearance-none cursor-pointer checked:bg-yellow-500 checked:border-yellow-500"
                      type="checkbox"
                      value=""
                    />
                    <input
                      id="color7"
                      className="size-5 bg-green-500 border border-green-500 rounded-sm appearance-none cursor-pointer checked:bg-green-500 checked:border-green-500"
                      type="checkbox"
                      value=""
                    />
                    <input
                      id="color8"
                      className="size-5 border rounded-sm appearance-none cursor-pointer bg-slate-800 border-slate-800 checked:bg-slate-800 checked:border-slate-800"
                      type="checkbox"
                      value=""
                    />
                    <input
                      id="color9"
                      className="size-5 border rounded-sm appearance-none cursor-pointer bg-slate-200 border-slate-200 checked:bg-slate-200 checked:border-slate-200"
                      type="checkbox"
                      value=""
                    />
                    <input
                      id="color10"
                      className="size-5 border rounded-sm appearance-none cursor-pointer bg-emerald-300 border-embg-emerald-300 checked:bg-emerald-300 checked:border-embg-emerald-300"
                      type="checkbox"
                      value=""
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <label
                        ...
                        className="align-middle cursor-pointer"
                      >
                        <Star className="inline-block size-4 ml-1 text-yellow-500 align-middle" />{' '}
                        <span className="align-middle">5 Rating</span>
                      </label>
                    </div>
                    <div className="flex items-center gap-2">
                      <input
                      ...
                      >
                        <Star className="inline-block size-4 ml-1 text-yellow-500 align-middle" />{' '}
                        <span className="align-middle">4 Rating and Up</span>
                      </label>
                    </div>
                    <div className="flex items-center gap-2">
                      <input
                      ...
                      >
                        <Star className="inline-block size-4 ml-1 text-yellow-500 align-middle" />{' '}
                        <span className="align-middle">3 Rating and Up</span>
                      </label>
                    </div>
                    <div className="flex items-center gap-2">
                      <input
                      ...
                      >
                        <Star className="inline-block size-4 ml-1 text-yellow-500 align-middle" />{' '}
                        <span className="align-middle">2 Rating and Up</span>
                      </label>
                    </div>
                    <div className="flex items-center gap-2">
                      <input
                      ...
                      >
                        <Star className="inline-block size-4 ml-1 text-yellow-500 align-middle" />{' '}
                        <span className="align-middle">1 Rating and Up</span>
                      </label>
                    </div>
                    <div className="flex items-center gap-2">
                      <input
                      ...
                      >
                        <Star className="inline-block size-4 ml-1 text-yellow-500 align-middle" />{' '}
                        <span className="align-middle">0 Rating</span>
                      </label>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex gap-2 shrink-0 items-cente">
              <Dropdown className="relative dropdown">
                ...
                >
                  Sort by: <b className="font-medium">Highest Price</b>
              ...
              >
                ...
                <div className="card-body !pt-0 md:group-[.gridView]:flex group-[.gridView]:!p-5 group-[.gridView]:gap-3 group-[.gridView]:grow">
                  ...
                  <div className="flex items-center gap-2 mt-4 group-[.gridView]:mt-0 group-[.gridView]:self-end">
                    ...
                    >
                      <ShoppingCart className="inline-block size-3 leading-none" />{' '}
