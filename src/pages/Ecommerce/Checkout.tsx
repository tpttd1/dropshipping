...
// Icon
import { ChevronLeft, MoveRight, ShoppingBag } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-x-5">
        <div className="xl:col-span-12">
          <div className="flex gap-1 px-4 py-3 mb-5 text-sm text-green-500 border border-green-200 rounded-md md:items-center bg-green-50 dark:bg-green-400/20 dark:border-green-500/50">
            <ShoppingBag className="h-4 shrink-0" />{' '}
            <p>
              The minimum order requirement is <b>$1,800</b>. To meet this
              threshold, please add additional products with a combined value of{' '}
              <b>$300</b>.
            </p>
          </div>
        </div>
        <div className="xl:col-span-8">
          <div className="flex items-center gap-3 mb-5">
            <div className="grow">
              <Link
                to="#!"
                className="transition-all duration-300 ease-linear text-custom-500 hover:text-custom-600"
              >
                <ChevronLeft className="inline-block size-4 align-middle ltr:mr-1 rtl:ml-1 rtl:rotate-180" />{' '}
                <span className="align-middle">Back to Cart</span>
              </Link>
            </div>
            <div className="shrink-0">
              ...
              >
                ...
                <MoveRight className="inline-block size-4 align-middle ltr:ml-1 rtl:mr-1 rtl:rotate-180" />
              </button>
            </div>
          </div>
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <label
                    htmlFor="deliveryOption1"
                    className="flex flex-col gap-4 p-5 border rounded-md cursor-pointer md:flex-row border-slate-200 dark:border-zink-500 peer-checked:border-purple-500 dark:peer-checked:border-purple-700 grow"
                  >
                    <span className="shrink-0">
                      <img src={delivery1} alt="" className="h-12" />
                    </span>
                    <span className="grow">
                      <span className="block mb-1 font-semibold text-15">
                        Express Delivery
                      </span>
          ...
          <div className="card">
            <div className="card-body">
              <h6 className="mb-4 text-15">Payment Information</h6>
              <form action="#!">
              ...
              <div className="mt-3">
                <h6 className="mb-1">We accept the following cards</h6>
                <div className="flex items-center gap-2">
                  <img src={paymentImg01} alt="" className="h-8" />
                  <img src={paymentImg02} alt="" className="h-8" />
                  <img src={paymentImg03} alt="" className="h-8" />
                  <img src={paymentImg04} alt="" className="h-8" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <div className="px-4 py-3 mb-4 text-sm text-red-500 border border-transparent rounded-md bg-red-50 dark:bg-red-400/20">
                ...
                <span className="font-bold">03m 21s</span>
              </div>
