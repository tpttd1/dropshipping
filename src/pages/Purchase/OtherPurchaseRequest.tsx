...
const OtherPurchaseRequest = () => {
  ...
  return (
    <React.Fragment>
      <BreadCrumb title="Other Purchase Request" pageTitle="Purchase Request" />
      <DeleteModal
        show={deleteModal}
        onHide={deleteToggle}
          ...
          <ul className="flex flex-wrap w-full mt-5 text-sm font-medium text-center text-gray-500 nav-tabs">
            <li className={`group ${activeTab === '1' && 'active'}`}>
              ...
              >
                ...
                <span className="align-middle">All Orders</span>
              </Link>
            </li>
            ...
            <li className={`group ${activeTab === '4' && 'active'}`}>
              ...
              >
                ...
                <span className="align-middle">Returns</span>
              </Link>
            </li>
...
export default OtherPurchaseRequest;
